...
(function (powerbi) {
    var visuals;
    (function (visuals) {
        var WaveGauge1460073141736;
        (function (WaveGauge1460073141736) {
            WaveGauge1460073141736.gaugeWaveChartProps = {
                values: {
                    pointerValue: { objectName: 'values', propertyName: 'pointerValue' },
                    evolution: { objectName: 'values', propertyName: 'evolution' },
                },
                color: {
                    circleColor: { objectName: 'color', propertyName: 'circleColor' },
                    waveColor: { objectName: 'color', propertyName: 'waveColor' },
                    textColor: { objectName: 'color', propertyName: 'textColor' },
                    waveTextColor: { objectName: 'color', propertyName: 'waveTextColor' }
                },
                wave: {
                    waveCount: { objectName: 'wave', propertyName: 'waveCount' },
                    waveRise: { objectName: 'wave', propertyName: 'waveRise' },
                    waveHeight: { objectName: 'wave', propertyName: 'waveHeight' },
                    waveRiseTime: { objectName: 'wave', propertyName: 'waveRiseTime' },
                    waveAnimateTime: { objectName: 'wave', propertyName: 'waveAnimateTime' },
                    waveAnimate: { objectName: 'wave', propertyName: 'waveAnimate' },
                    waveHeightScaling: { objectName: 'wave', propertyName: 'waveHeightScaling' },
                    waveOffset: { objectName: 'wave', propertyName: 'waveOffset' }
                },
                parameters: {
                    minValue: { objectName: 'parameters', propertyName: 'minValue' },
                    maxValue: { objectName: 'parameters', propertyName: 'maxValue' },
                    circleThickness: { objectName: 'parameters', propertyName: 'circleThickness' },
                    circleFillGap: { objectName: 'parameters', propertyName: 'circleFillGap' },
                    valueCountUp: { objectName: 'parameters', propertyName: 'valueCountUp' },
                    displayPercent: { objectName: 'parameters', propertyName: 'displayPercent' },
                    displayPercentforevo: { objectName: 'parameters', propertyName: 'displayPercentforevo' },
                    x100: { objectName: 'parameters', propertyName: 'x100' },
                    x100forevo: { objectName: 'parameters', propertyName: 'x100forevo' },
                    decimalpointerValue: { objectName: 'parameters', propertyName: 'decimalpointerValue' },
                    decimalevolution: { objectName: 'parameters', propertyName: 'decimalevolution' }
                },
                text: {
                    textVertPosition: { objectName: 'text', propertyName: 'textVertPosition' },
                    textSize: { objectName: 'text', propertyName: 'textSize' }
                }
            };
            WaveGauge1460073141736.gaugeWaveChartRoleNames = {
                pointerValue: 'pointerValue',
                evolution: 'evolution',
            };
            var WaveGauge = (function () {
                function WaveGauge() {
                }
                WaveGauge.DefaultStyleProperties = function () {
                    return {
                        values: {
                            pointerValue: 0,
                ...
                WaveGauge.converter = function (dataView, options) {
                    var gaugeModel;
                    if (!dataView) {
                        return;
                    }
                    ...
                    if (objects) {
                        defaultSettings.values.pointerValue = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.values.pointerValue, defaultSettings.values.pointerValue);
                        defaultSettings.values.evolution = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.values.evolution, defaultSettings.values.evolution);
                        //Update Values of each parameters from parameters settings of gaugeWaveChart Properties
                        //Update Color
                        defaultSettings.color.circleColor = powerbi.DataViewObjects.getFillColor(objects, WaveGauge1460073141736.gaugeWaveChartProps.color.circleColor, defaultSettings.color.circleColor);
                        defaultSettings.color.waveColor = powerbi.DataViewObjects.getFillColor(objects, WaveGauge1460073141736.gaugeWaveChartProps.color.waveColor, defaultSettings.color.waveColor);
                        defaultSettings.color.textColor = powerbi.DataViewObjects.getFillColor(objects, WaveGauge1460073141736.gaugeWaveChartProps.color.textColor, defaultSettings.color.textColor);
                        defaultSettings.color.waveTextColor = powerbi.DataViewObjects.getFillColor(objects, WaveGauge1460073141736.gaugeWaveChartProps.color.waveTextColor, defaultSettings.color.waveTextColor);
                        //Update Wave parameters
                        defaultSettings.wave.waveCount = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.wave.waveCount, defaultSettings.wave.waveCount);
                        defaultSettings.wave.waveRise = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.wave.waveRise, defaultSettings.wave.waveRise);
                        defaultSettings.wave.waveRiseTime = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.wave.waveRiseTime, defaultSettings.wave.waveRiseTime);
                        defaultSettings.wave.waveAnimate = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.wave.waveAnimate, defaultSettings.wave.waveAnimate);
                        defaultSettings.wave.waveAnimateTime = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.wave.waveAnimateTime, defaultSettings.wave.waveAnimateTime);
                        defaultSettings.wave.waveHeight = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.wave.waveHeight, defaultSettings.wave.waveHeight);
                        defaultSettings.wave.waveHeightScaling = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.wave.waveHeightScaling, defaultSettings.wave.waveHeightScaling);
                        defaultSettings.wave.waveOffset = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.wave.waveOffset, defaultSettings.wave.waveOffset);
                        //Update parameters divers
                        defaultSettings.parameters.circleFillGap = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.parameters.circleFillGap, defaultSettings.parameters.circleFillGap);
                        defaultSettings.parameters.circleThickness = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.parameters.circleThickness, defaultSettings.parameters.circleThickness);
                        defaultSettings.parameters.displayPercent = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.parameters.displayPercent, defaultSettings.parameters.displayPercent);
                        defaultSettings.parameters.displayPercentforevo = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.parameters.displayPercentforevo, defaultSettings.parameters.displayPercentforevo);
                        defaultSettings.parameters.maxValue = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.parameters.maxValue, defaultSettings.parameters.maxValue);
                        defaultSettings.parameters.minValue = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.parameters.minValue, defaultSettings.parameters.minValue);
                        defaultSettings.parameters.valueCountUp = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.parameters.valueCountUp, defaultSettings.parameters.valueCountUp);
                        defaultSettings.parameters.x100 = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.parameters.x100, defaultSettings.parameters.x100);
                        defaultSettings.parameters.x100forevo = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.parameters.x100forevo, defaultSettings.parameters.x100forevo);
                        defaultSettings.parameters.decimalpointerValue = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.parameters.decimalpointerValue, defaultSettings.parameters.decimalpointerValue);
                        defaultSettings.parameters.decimalevolution = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.parameters.decimalevolution, defaultSettings.parameters.decimalevolution);
                        //Update Text parameters
                        defaultSettings.text.textSize = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.text.textSize, defaultSettings.text.textSize);
                        defaultSettings.text.textVertPosition = powerbi.DataViewObjects.getValue(objects, WaveGauge1460073141736.gaugeWaveChartProps.text.textVertPosition, defaultSettings.text.textVertPosition);
                    }
                    ...
                    for (var idx = 0; idx < categoryValuesLen; idx++) {
                        var PointerValue = undefined, Evolution = undefined;
                        ...
                        for (var i = 0; i < values.length; i++) {
                            ...
                            if (col && col.roles) {
                                if (col.roles[WaveGauge1460073141736.gaugeWaveChartRoleNames.evolution]) {
                                    Evolution = currentVal;
                                }
                                else if (col.roles[WaveGauge1460073141736.gaugeWaveChartRoleNames.pointerValue]) {
                ...
                WaveGauge.prototype.init = function (options) {
                    ...
                    this.bodydiv = d3.select(options.element.get(0)).append('div').classed('wave_gauge_bodydiv', true);
                    //Add gauge html item
                    this.htmlgauge = this.bodydiv.append('svg').classed('wave_gauge', true).attr("id", this.guidgauge);
                    //Add a div for img of evolution
                    this.divprogression = this.bodydiv.append('div').classed('wave_gauge_div', true).attr("id", this.guid_div);
                    //Add picture of evolution down
                    this.imgprogression_red = this.divprogression.append('img').classed('wave_gauge_img_red', true).attr("src", sampleImgRed);
                    //Add picture of evolution Up
                    this.imgprogression_green = this.divprogression.append('img').classed('wave_gauge_img_green', true).attr("src", sampleImgReeg);
                    //Add value of progression
                    this.progressionText = this.divprogression.append('div').classed('wave_gauge_progressionText', true);
                ...
                WaveGauge.prototype.update = function (options) {
                    if (!options.dataViews && !options.dataViews[0])
                        return;
                    var dataView = options.dataViews[0];
                    var model = WaveGauge.converter(dataView, options);
                    if (!model) {
                        return;
                    }
                    this.model = model;
                ...
                WaveGauge.prototype.guid = function (title) {
                    function s4() {
                        return Math.floor((1 + Math.random()) * 0x10000).toString(16).substring(1);
                    }
                    return title + s4() + s4() + '-' + s4() + '-' + s4() + '-' + s4() + '-' + s4() + s4() + s4();
                };
                //Display parameters in ribon (tab) parameters of chart
                WaveGauge.prototype.enumerateObjectInstances = function (options) {
                ...
                WaveGauge.capabilities = {
                    ...
                    objects: {
                        color: {
                            displayName: powerbi.data.createDisplayNameGetter('Color'),
                            properties: {
                                circleColor: {
                                    displayName: 'Circle',
                        ...
                        wave: {
                            displayName: powerbi.data.createDisplayNameGetter('Wave'),
                            properties: {
                                waveCount: {
                                    displayName: 'Count',
                                    type: { numeric: true }
                        ...
                        parameters: {
                            displayName: powerbi.data.createDisplayNameGetter('Parameters'),
                            properties: {
                                maxValue: {
                                ...
                                decimalpointerValue: {
                                    displayName: 'decimalpointerValue',
                                    type: { numeric: true }
                                },
                                decimalevolution: {
                                    displayName: 'decimalevolution',
                                    type: { numeric: true }
                                }
                            }
                        },
            ...
            WaveGauge1460073141736.WaveGauge = WaveGauge;
        ...
        })(WaveGauge1460073141736 = visuals.WaveGauge1460073141736 || (visuals.WaveGauge1460073141736 = {}));
...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    var gaugeGrouppath = gaugeGroup.append("path").attr("d", gaugeCircleArc).style("fill", config.circleColor).attr('transform', 'translate(' + radius + ',' + radius + ')');
    ...
    var fillCircleGroupcircle = fillCircleGroup.append("circle").attr("cx", radius).attr("cy", radius).attr("r", fillCircleRadius).style("fill", config.waveColor);
    ...
    function GaugeUpdater() {
        this.update = function (value, conf, width, height) {
            ...
            // Scales for controlling the position of the clipping path.
            waveRiseScale = d3.scale.linear().range([(fillCircleMargin + fillCircleRadius * 2 + waveHeight), (fillCircleMargin - waveHeight)]).domain([0, 1]);
            waveAnimateScale = d3.scale.linear().range([0, waveClipWidth - fillCircleRadius * 2]).domain([0, 1]);
            // Scale for controlling the position of the text within the gauge.
            textRiseScaleY = d3.scale.linear().range([fillCircleMargin + fillCircleRadius * 2, (fillCircleMargin + textPixels * 0.7)]).domain([0, 1]);
            // Center the gauge within the parent SVG.
            gaugeGroup.attr('transform', 'translate(' + locationX + ',' + locationY + ')');
            // Draw the outer circle.
            gaugeCircleArc = d3.svg.arc().startAngle(gaugeCircleX(0)).endAngle(gaugeCircleX(1)).outerRadius(gaugeCircleY(radius)).innerRadius(gaugeCircleY(radius - circleThickness));
            gaugeGrouppath.attr("d", gaugeCircleArc).style("fill", config.circleColor).attr('transform', 'translate(' + radius + ',' + radius + ')');
            // Text where the wave does not overlap.
            text1.text(textRounder(textStartValue) + percentText).attr("class", "liquidFillGaugeText").attr("text-anchor", "middle").attr("font-size", textPixels + "px").style("fill", config.textColor).attr('transform', 'translate(' + radius + ',' + textRiseScaleY(config.textVertPosition) + ')');
            // The clipping wave area.
            clipArea = d3.svg.area().x(function (d) {
                return waveScaleX(d.x);
            }).y0(function (d) {
                return waveScaleY(Math.sin(Math.PI * 2 * config.waveOffset * -1 + Math.PI * 2 * (1 - config.waveCount) + d.y * 2 * Math.PI));
            }).y1(function (d) {
            ...
            fillCircleGroupcircle.attr("cx", radius).attr("cy", radius).attr("r", fillCircleRadius).style("fill", config.waveColor);
            // Text where the wave does overlap.
            text2.text(textRounder(textStartValue) + percentText).attr("class", "liquidFillGaugeText").attr("text-anchor", "middle").attr("font-size", textPixels + "px").style("fill", config.waveTextColor).attr('transform', 'translate(' + radius + ',' + textRiseScaleY(config.textVertPosition) + ')');
            // Make the value count up.
            if (config.valueCountUp) {
                var textTween = function () {
                    var i = d3.interpolate(this.textContent, textFinalValue);
            ...
            wave.datum(data).attr("d", clipArea).attr("T", 0);
            // Make the wave rise. wave and waveGroup are separate so that horizontal and vertical movement can be controlled independently.
...
(function (powerbi) {
    ...
    (function (visuals) {
        var plugins;
        (function (plugins) {
            plugins.WaveGauge1460073141736 = {
                name: 'WaveGauge1460073141736',
                class: 'WaveGauge1460073141736',
                capabilities: powerbi.visuals.WaveGauge1460073141736.WaveGauge.capabilities,
                custom: true,
                create: function () { return new powerbi.visuals.WaveGauge1460073141736.WaveGauge(); }
            };
